...
captchaPath = "c:\\Sikulix_scripts\\git_sikulix_taximoney\\sikulix_taximoney\\captcha_betting\\"
           ...
           "betting":
                ...
                "dictBK":{
                    ...
                    "NIRVANA БК": "https://www.taxi-money.in/bookmaker-company/3",
                     "Mimicry83": "https://www.taxi-money.in/bookmaker-company/61",
...
firefox = App(r"c:\\FirefoxPortable\\App\\Firefox64\\firefox.exe")
firefox.open()
            ...
            if exists(_picFindWords,1): 
                ...
                if findExists(_btnPlaceABetWord, _btnPlaceABet, 3):
                    ...
                    if findExists(_btnSubmitABidForProcessingWord, _btnSubmitABidForProcessing, 3):
                        while exists(_btnSubmitABidForProcessing, 1):
...
logger.setBaseConfig('log_betting.log')
logger.warning("test")
